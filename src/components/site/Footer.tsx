      ...
      <div className="container-page grid gap-10 py-14 md:grid-cols-4">
        <div className="md:col-span-2">
          ...
          <p className="mt-4 max-w-md text-sm leading-7 text-muted-foreground">
            منصة عربية متخصّصة في الإرشاد التربوي والأكاديمي والمهني —
            نرافق الطلاب والخريجين والمرشدين بمنهجية علمية ومقاييس مفتوحة الترخيص.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <li><Link to="/career-sims" className="hover:text-primary">Career Micro-Sims — جرّب المهنة</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-muted-foreground">
            ...
            <li><Link to="/refund" className="hover:text-primary">سياسة الاسترداد</Link></li>
            <li><Link to="/licensing" className="hover:text-primary">تراخيص المقاييس</Link></li>
