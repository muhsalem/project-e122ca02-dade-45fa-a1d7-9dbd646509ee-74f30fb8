...
## ١٤. اقتراح التخصصات الدراسية المناسبة
بناءً على إجابات قسم "اكتشف التخصص الدراسي المناسب لك" مدمجة مع نمط التعلم والذكاءات المتعددة والميول، قدّم:
- **أفضل 5 تخصصات جامعية** مرتبة حسب التوافق، مع نسبة توافق تقديرية (%) لكل تخصص، وشرح سبب الترشيح.
- **3 تخصصات بديلة / ثانية** مناسبة كخيار احتياطي.
- **عائلة التخصصات الموصى بها** (طبية/هندسية/تقنية/إنسانية/إدارية/فنية...).
- **مسارات دراسية مقترحة** (بكالوريوس، دبلوم تقني، شهادات مهنية) بحسب استعداده.
- **تخصصات يُفضل تجنبها** ولماذا لا تناسب نمطه.

## ١٥. أسئلة للنقاش مع المرشد النفسي/التربوي
5-7 أسئلة عميقة يطرحها المتعلم خلال الجلسة (تشمل نمط التعلم واختيار التخصص).
