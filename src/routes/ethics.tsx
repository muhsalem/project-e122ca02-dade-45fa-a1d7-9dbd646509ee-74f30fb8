  ...
  return (
    <article className="container-page max-w-3xl py-16 leading-relaxed">
      ...
      <section className="mt-8 space-y-5 text-foreground/90">
        ...
        <ul className="list-disc pr-6 space-y-1">
          <li>الذكاء الاصطناعي عندنا <strong>أداة مساعدة</strong> وليس مفتياً ولا طبيباً.</li>
          <li>نمنع النموذج من إصدار فتاوى شرعية أو تشخيصات طبية.</li>
          <li>نُوجّه النموذج لاحترام الثوابت القيمية في كل تقرير يُولّده.</li>
        </ul>
