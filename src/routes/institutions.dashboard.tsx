    ...
    <>
      <section className="border-b border-border bg-secondary/40">
        <div className="container-page py-14">
          ...
          <div className="mt-5 max-w-2xl rounded-xl border border-primary/30 bg-primary/5 p-4 text-sm leading-7 text-primary">
            <strong>سياسة الإخفاء (K-Anonymity ≥ 5):</strong> لا تُعرض أي نتيجة فريق أو قسم
            يقلّ عدده عن <strong>٥ أفراد</strong>، حمايةً لخصوصية الموظّف الواحد. تُخفى
            البطاقات تلقائيًا وتُستبدل بمؤشّر «العيّنة صغيرة». ولا يصل أي مدير إلى نتيجة
            فردية مرتبطة باسم — فقط متوسّطات مجمّعة.
          </div>
        </div>
      </section>
