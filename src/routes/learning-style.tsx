...
const SECTIONS: Section[] = [
  ...
  {
    key: "academic",
    title: "اكتشف التخصص الدراسي المناسب لك",
    intro: "أسئلة تكشف ميولك الأكاديمية لاقتراح أنسب التخصصات الجامعية والمسارات الدراسية.",
    questions: [
      {
      ...
      },
      {
        ...
        q: "بيئة العمل الدراسية/المهنية المثالية لك:",
        type: "single",
        options: [
      ...
      },
      {
        ...
        maxSelect: 3,
        options: [
          "التفكير المنطقي والتحليل",
          "الحساب والأرقام",
          "الكتابة والتعبير اللغوي",
          "التواصل والإقناع",
          "القيادة وتنظيم الفرق",
          "الإبداع والتصميم البصري",
          "المهارات اليدوية والتقنية",
          "البحث وجمع المعلومات",
          "التعاطف ومساعدة الآخرين",
          "حفظ المعلومات وتذكّرها",
        ],
      },
      {
