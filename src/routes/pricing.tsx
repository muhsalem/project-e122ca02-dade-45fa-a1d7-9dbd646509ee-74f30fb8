      ...
      <section className="border-b border-border bg-secondary/40">
        <div className="container-page py-16 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-muted-foreground leading-9">
            ...
            وجلسات الكوتشينج تبدأ بجلسة تعارف مجانية للتأكد من توافقك مع الكوتش قبل أي دفع.
          </p>
        </div>
      </section>
      ...
      <section className="border-y border-border bg-secondary/40">
        <div className="container-page grid gap-8 py-14 md:grid-cols-3">
          {[
            ...
            { icon: Gift, t: "جلسة تعارف مجانية", d: "15 دقيقة مع الكوتش قبل أي حجز للتأكد من التوافق." },
