...
const tiers = [
  {
    ...
    sub: "بدون تسجيل",
    features: [
      "اكتشف ميولك المهنية (O*NET Interest Profiler)",
      "مؤشر الاحتراق المهني (OLBI)",
  ...
  },
  {
    ...
    features: [
      "التقييم الشامل (O*NET IP + OLBI + IPIP-NEO)",
      ...
      <section className="container-page py-16">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          {[
            {
              track: "مسار الاكتشاف",
              free: ["اكتشف ذاتك (O*NET IP + IPIP-NEO Big Five)", "اكتشف مسارك المهني (ISCO-08)", "القيم المهنية (O*NET Work Values)", "نمط التعلّم (VARK + Kolb)", "اقتراح التخصص الجامعي"],
              paid: ["تقرير AI تفصيلي PDF (قريبًا) — 49 ر.س", "جلسة إرشاد جامعي 60 دق — 350 ر.س"],
            },
            {
              track: "مسار التغيير",
              free: ["تشخيص الرغبة في تغيير المسار", "مؤشر الاحتراق المهني (OLBI)", "الفحص النفسي المختصر (PHQ-2 + GAD-2)", "حالة الهوية المهنية (VISA)"],
