    ...
    <article className="container-page max-w-3xl py-16 leading-relaxed">
      ...
      <section className="mt-8 space-y-4 text-foreground/90">
        ...
        <ul className="list-disc pr-6 space-y-1">
          ...
          <li>التصحيح أو الحذف أو تقييد المعالجة.</li>
          <li>سحب الموافقة في أي وقت دون أثر رجعي.</li>
          <li>
            <strong>حق رفض القرار الآلي</strong>: لك أن تطلب مراجعة بشريّة لأي
            تقرير أصدره الذكاء الاصطناعي قبل اتخاذ قرار مصيري بناءً عليه.
          </li>
          <li>
