...
const STEPS = [
  ...
  { letter: "O", title: "Options — الخيارات", color: "text-gold", desc: "ولّد بدائل متعددة قبل اختيار واحد. الكوتش لا يقترح — بل يستخرج.", qs: ["ما 5 طرق مختلفة للوصول لهدفك؟", "لو لم تكن أي قيود، ماذا ستفعل؟", "من تعرف نجح في موقف مشابه؟ كيف فعلها؟"] },
...
function Article() {
  return (
    <article className="container-page max-w-3xl py-14">
      ...
      <h1 className="mt-4 text-4xl text-primary md:text-5xl leading-tight">نموذج GROW: أداة الكوتش الأساسية</h1>
      ...
      <p className="mt-3 leading-8">الكوتش لا يقدّم حلولًا. مهمته أن يسأل أسئلة تجعل العميل يكتشف الحل بنفسه. اقطع نفسك كلما شعرت أنك تنصح، وحوّل النصيحة إلى سؤال.</p>

      <div className="mt-12 rounded-2xl border border-gold/30 bg-gold/5 p-6 text-center">
        <h3 className="font-serif text-xl text-primary">جرّب GROW مع كوتش معتمد</h3>
