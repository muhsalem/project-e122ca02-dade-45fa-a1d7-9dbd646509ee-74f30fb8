...
const SECTIONS: Section[] = [
  ...
  {
    key: "strengths_constellation",
    title: "كوكبة نقاط القوة (CliftonStrengths)",
    intro: "مبني على المجالات الأربعة لـ Gallup: التنفيذ، التأثير، بناء العلاقات، التفكير الاستراتيجي. اختر ما يصفك فعلاً.",
    questions: [
      {
        id: "str_executing",
        q: "في التنفيذ والإنجاز — أي العبارات تصفك أكثر؟ (اختر حتى 2)",
        type: "multi",
        maxSelect: 2,
        options: [
          "المنجِز (Achiever) — أحب إنهاء قوائم المهام وأشعر بطاقة من الإنتاج",
          "المنظِّم (Arranger) — أنسّق الموارد والناس لأقصى كفاءة",
          "المؤمن (Belief) — قيمي الراسخة توجّه عملي",
          "المسؤول (Responsibility) — ألتزم بما أعِد به حرفياً",
          "المُركّز (Focus) — أحدد الأولوية وأمضي دون تشتت",
          "المنضبط (Discipline) — أحب الروتين والهيكل الواضح",
        ],
      },
      {
        id: "str_influencing",
        q: "في التأثير والإقناع — أي العبارات تصفك أكثر؟ (اختر حتى 2)",
        type: "multi",
        maxSelect: 2,
        options: [
          "القائد (Command) — أتولى زمام الموقف بسهولة",
          "المُتواصل (Communication) — أجيد صياغة الأفكار وعرضها",
          "التنافسي (Competition) — أُحفَّز بالمقارنة والفوز",
          "الواثق (Self-Assurance) — لدي ثقة داخلية بقراراتي",
          "الجاذب (Woo) — أكسب الغرباء بسرعة",
          "الفاعل (Activator) — أحوّل الأفكار إلى أفعال فوراً",
        ],
      },
      {
        id: "str_relationship",
        q: "في بناء العلاقات — أي العبارات تصفك أكثر؟ (اختر حتى 2)",
        type: "multi",
        maxSelect: 2,
        options: [
          "المتعاطف (Empathy) — أشعر بمشاعر الآخرين بسهولة",
          "المُنسّق (Harmony) — أبحث عن نقاط الاتفاق وأتجنب الصدام",
          "المُطوِّر (Developer) — أرى إمكانات الناس وأرعى نموهم",
          "المُضمِّن (Includer) — أحرص ألا يُستبعد أحد",
          "الإيجابي (Positivity) — أنشر الحماس والتفاؤل",
          "العلائقي (Relator) — أُفضّل صداقات عميقة قليلة",
        ],
      },
      {
        id: "str_strategic",
        q: "في التفكير الاستراتيجي — أي العبارات تصفك أكثر؟ (اختر حتى 2)",
        type: "multi",
        maxSelect: 2,
        options: [
          "التحليلي (Analytical) — أبحث عن الأدلة والأنماط",
          "الاستراتيجي (Strategic) — أرى مسارات متعددة وأختار الأفضل",
          "المُتعلِّم (Learner) — أُحَب عملية التعلم نفسها",
          "المُستكشف (Ideation) — تأتيني الأفكار بسهولة",
          "الاستبصاري (Futuristic) — أُلهَم برؤى المستقبل",
          "السياقي (Context) — أفهم الحاضر بالرجوع للماضي",
        ],
      },
    ],
  },
  {
    key: "ikigai_meaning",
    title: "إيكيغاي — تقاطع المعنى",
    intro: "النموذج الياباني لأربعة دوائر: ما تحبه × ما تجيده × ما يحتاجه العالم × ما يُدفع لك مقابله.",
    questions: [
      {
        id: "iki_love",
        q: "النشاط الذي تحبه فعلاً ولو بدون مقابل:",
        type: "single",
        options: [
          "التعلم والقراءة والبحث",
          "الكتابة والتعبير والإبداع",
          "بناء وصنع أشياء ملموسة",
          "مساعدة الآخرين وتوجيههم",
          "حل ألغاز وتحديات تقنية",
          "تنظيم وقيادة فرق",
          "الفن والتصميم والجمال",
          "السفر واكتشاف الثقافات",
        ],
      },
      {
        id: "iki_good_at",
        q: "ما يقول الناس إنك تجيده أكثر من غيرك:",
        type: "single",
        options: [
          "الشرح والتبسيط",
          "التحليل واكتشاف الأنماط",
          "الإقناع والمفاوضة",
          "التعاطف والإصغاء",
          "التنفيذ والإنجاز",
          "الإبداع والابتكار",
          "القيادة واتخاذ القرار",
          "الإتقان الفني/الحرفي",
        ],
      },
      {
        id: "iki_world_needs",
        q: "أهم احتياج مجتمعي تشعر بمسؤولية تجاهه:",
        type: "single",
        options: [
          "تعليم أفضل للشباب",
          "صحة نفسية وجسدية",
          "حلول تقنية للمشاكل اليومية",
          "بيئة وممارسات مستدامة",
          "تمكين اقتصادي للأسر",
          "محتوى معرفي عربي راقٍ",
          "خدمات للفئات الهشة",
          "ابتكار في الأعمال والصناعة",
        ],
      },
      {
        id: "iki_paid_for",
        q: "ما الذي يدفع السوق فعلاً مقابلَه ضمن قدراتك الحالية أو القريبة؟",
        type: "single",
        options: [
          "مهارات تقنية/برمجية",
          "تحليل بيانات",
