  ...
  head: () => ({
    meta: [
      { title: "خريطة التخصصات الجامعية الشاملة — بوصلة" },
      {
        name: "description",
        content:
          "استكشف +585 تخصصًا دقيقًا عبر 39 مجالًا (ISCED-F 2013)، مع المسارات المهنية والمميزات والتحديات لكل تخصص.",
      },
    ],
  }),
      ...
      <section className="border-b border-border bg-secondary/40">
        <div className="container-page py-12 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-sm text-muted-foreground">
            39 مجالًا • 128 تخصصًا عامًا • +585 تخصصًا دقيقًا — وفق التصنيف الدولي ISCED-F 2013.
            اختر تخصصك واعرف المسارات المهنية والمميزات والتحديات.
          </p>
        </div>
      </section>
